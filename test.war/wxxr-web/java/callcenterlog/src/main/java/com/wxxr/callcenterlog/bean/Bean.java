...
public class Bean {
	...
	public String toString() {
		return "Bean [stringField=" + stringField + ", intField=" + intField
				+ ", booleanField=" + booleanField + ", charField=" + charField
				+ ", longField=" + longField + ", floatField=" + floatField
				+ ", doubleField=" + doubleField + ", objectField="
				+ objectField + ", byteField=" + byteField + ", enumField="
				+ enumField + ", enumBean=" + enumBean + ", bigDecimal="
